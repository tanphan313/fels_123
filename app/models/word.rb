class Word < ActiveRecord::Base
  ...
  def validate
    errors.add :word_answers,
      I18n.t("at_least_one_correct") unless word_answers.select{|answer| answer.correct?}.count > 0
    errors.add :word_answers,
      I18n.t("at_least_two_answers") unless word_answers.select{|answer| answer.present?}.count > 1
  end
